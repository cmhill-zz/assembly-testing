...
python ../../../errorgenerator/errorGen.py -a ../../../data/buchnera/600000/buchnera-udp.assembly.fasta -o assembly.fasta -m oracle -e 500000 -l 200

#Generate 5x read coverage over error assembly
wgsim -1 600 -2 600 -R 0.0 -X 0.0 -e 0.0 -N 5000 assembly.fasta reads.1.fastq reads.2.fastq
