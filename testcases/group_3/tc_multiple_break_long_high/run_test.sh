...
python ../../../errorgenerator/errorgen.py -a ../../../data/buchnera/600000/buchnera-udp.assembly.fasta -o multipleErrorAssembly.fasta -m oracle -e 4000 -l 200

#Generate 5x read coverage over error assembly
wgsim -1 600 -2 600 -R 0.0 -X 0.0 -e 0.0 -N 5000 multipleErrorAssembly.fasta multiple.1.fastq multiple.2.fastq
