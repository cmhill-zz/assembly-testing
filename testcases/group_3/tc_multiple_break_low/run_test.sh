...
python ../../../errorgenerator/errorGen.py -a ../../../data/buchnera/3000/buchnera-udp.assembly.fasta -o assembly.fasta -m oracle -e 250 -l 200

#Generate 5x read coverage over error assembly
wgsim -1 300 -2 300 -R 0.0 -X 0.0 -e 0.0 -N 50 assembly.fasta reads.1.fastq reads.2.fastq
